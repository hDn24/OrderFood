...
import com.hdn.orderfood.DAO.NhanVienDAO;
import com.hdn.orderfood.DAO.QuyenDAO;
import com.hdn.orderfood.DTO.NhanVienDTO;
import com.hdn.orderfood.DTO.QuyenDTO;
import com.hdn.orderfood.FragmentApp.DatePickerFragment;
...
//            quyenDAO.ThemQuyen("nhân viên");
    ...
    private void DongYThemNhanVien(){
        ...
        if(sTenDangNhap == null || sTenDangNhap.equals("")){
            Toast.makeText(DangKiActivity.this,getResources().getString(R.string.loinhaptendangnhap), Toast.LENGTH_SHORT).show();
        }else if(sMatKhau == null || sMatKhau.equals("")){
            Toast.makeText(DangKiActivity.this,getResources().getString(R.string.loinhapmatkhau), Toast.LENGTH_SHORT).show();
        }else{
            ...
            if(kiemtra != 0){
                Toast.makeText(DangKiActivity.this,getResources().getString(R.string.themthanhcong), Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(DangKiActivity.this,getResources().getString(R.string.themthatbai), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void SuaNhanVien(){
        ...
        if(kiemtra){
            Toast.makeText(DangKiActivity.this,getResources().getString(R.string.suathanhcong),Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(DangKiActivity.this,getResources().getString(R.string.loi),Toast.LENGTH_SHORT).show();
        }
